...
function buildEventPopup(event, element) {
    ...
    if (event.editable) {
        ...
        editButton.append($('<a>', {
            ...
            href: Craft.getCpUrl('calendar/events/' + event.id),
            text: Craft.t('event_edit')
        }));

        editButton.append($('<a>', {
            class: 'btn small delete-event',
            href: Craft.getCpUrl('calendar/events/api/delete'),
            text: Craft.t('event_delete'),
            data: {
                id: event.id
            }
        }));
        ...
        if (event.repeats) {
            editButton.append($('<a>', {
                ...
                text: Craft.t('event_delete_occurrence'),
                data: {
                    id: event.id,
        ...
        events: {
            ...
            render: function (e, api) {
                $('a.delete-event-occurrence', api.elements.content).click(function (e) {
                    ...
                    if (confirm(Craft.t('event_delete_occurrence_confirmation'))) {
                        var data = {
                            eventId: eventId,
                            date: date
                        };
                ...
                $('a.delete-event', api.elements.content).click(function (e) {
                    ...
                    if (confirm(Craft.t('event_delete_confirmation'))) {
                        var data = {
                            eventId: eventId
                        };
