...
class SherlockService extends BaseApplicationComponent
{
    ...
    */
    ...
    public function getCpAlerts()
    {
        ...
        {
            $alerts[] = 'You are running a free unlicensed version of Sherlock on a Craft '.craft()->getEditionName().' license. <a href="https://www.putyourlightson.net/" class="go" target="_blank">Buy Plugin License</a>';
        }
