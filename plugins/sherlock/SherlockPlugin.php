...
class SherlockPlugin extends BasePlugin
{
    ...
    protected function defineSettings()
    {
        return array(
            ...
            'notificationEmailAddresses' => array(AttributeType::String, 'default' => craft()->email->getSettings()['emailAddress']),
            'pluginVulnerabilitiesFeedUrl' => array(AttributeType::String, 'default' => 'https://raw.githubusercontent.com/putyourlightson/craft-plugin-vulnerabilities/master/vulnerabilities.json'),
            'apiKey' => array(AttributeType::String, 'default' => StringHelper::randomString()),
            'restrictControlPanelIpAddresses' => AttributeType::String,
            'restrictFrontEndIpAddresses' => AttributeType::String,
        );
    }
